...
class TritonPythonModel:
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            in_0 = pb_utils.get_input_tensor_by_name(request, "text_no_punc")

            text_no_punc = in_0.as_numpy()  # 得到 numpy 数组，dtype=object，shape=[batch_size, 1]

            text_no_punc_list=[x[0].decode("utf-8") for x in text_no_punc]
            # print("text_no_punc is :",text_no_punc)
            total_seq += 1
